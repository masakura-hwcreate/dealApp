        ...
        <div class="container px-5 py-24 mx-auto">
            <div class="lg:w-1/2 md:w-2/3 mx-auto">
                ...
                <div class="flex flex-wrap -m-2">
                    ...
                    <div class="p-2 w-1/3">
                    <div class="relative">
                        <label for="payment_method" class="leading-7 text-sm text-gray-600">案件確度</label>
                        <select id="payment_method" name="payment_method" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="sales_amount" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                    </div>
                    </div>
                    <div class="p-2 w-1/3">
                    <div class="relative">
